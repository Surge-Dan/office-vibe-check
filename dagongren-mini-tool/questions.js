(function (root) {
  ...
  // 基础题和分支题必须跨行业成立：它们只讨论时间、责任、边界、沟通和情绪，不预设办公室或互联网工作方式。
  const universalScenes = {
    'a-overtime': '周五 18:20，负责人发来一句“今晚辛苦一下”，但没有说清要做到什么程度。你会：',
    'a-vague': '刚接到一件新任务，负责人只说“你先把这事盘起来”，没有目标、资源和截止时间。你会：',
    'a-dump': '同事私下说：“这个你比较熟，顺手帮我做了吧。”但它明显不在你的职责里。你会：',
    'a-critique': '负责人当众评价你的工作“这个思路不太行”，却没有说明具体原因。你会：',
    'a-promise': '阶段评价时，负责人说“继续保持，之后有机会给你更大空间”。你的第一反应是：',
    'a-incident': '一项工作刚交出去就出现问题，现场同时有人催进度、问责任、提办法。你会先：',
    'a-meeting': '一个十分钟能说清的事情，已经讨论到第 50 分钟，大家还在重复观点。你会：',
    'a-help': '你已经排满，同事说自己的事情今晚不做完会被点名，希望你救一下。你会：',
    'a-credit': '复盘时，同事把你完成的关键成果说成“我们一起做出来的”。你会：',
    'a-low-return': '一件事情反复改方向，几个月没有结果，投入却还在持续减少。你会：',
    'a-afterhours': '周日晚上，有人来找你处理一个周一上午再做也来得及的事情。你会：',
    'a-career': '你遇到一个回报更高、但边界模糊的新机会；现在的工作稳定，却越来越消耗。你会：',
    'b-drive-1': '阶段目标已经完成 90%，负责人临时又加了一个“能做更好”的冲刺项。你会：',
    'b-drive-2': '身边的人连续熬夜晒进度，你的工作按时完成，却显得不够热闹。你会：',
    'b-drive-3': '有一件没人负责、但做成后容易被看见的事情。你会：',
    'b-drive-4': '一份材料已经够用，但你看到还有三处可以继续打磨。你会：',
    'b-rumination-1': '你完成一次重要沟通后，负责人两个小时没有回复。你会：',
    'b-rumination-2': '阶段评价比预期低半档，但对方给出的反馈很笼统。你会：',
    'b-rumination-3': '同事路过时说：“你最近看起来挺闲的。”你会：',
    'b-rumination-4': '离开工作场景后，你突然想起白天一句没接好的话。你会：',
    'b-boundary-1': '负责人让你“顺便”接手离开同事留下的工作，却没说原来的事情怎么调整。你会：',
    'b-boundary-2': '相关方连续第三次把自己的延期变成你的加急。你会：',
    'b-boundary-3': '同事习惯在你的休息时间拉你讨论工作。你会：',
    'b-boundary-4': '有人把你拉进一个“先支持一下”的长期协作，却没有明确职责。你会：',
    'b-upward-1': '负责人提出一个你判断成本很高、回报很低的工作要求。你会：',
    'b-upward-2': '你的事情缺一个关键资源，负责人一直回复“再协调”。你会：',
    'b-upward-3': '一对一沟通时，负责人问：“最近有没有什么困难？”你会：',
    'b-upward-4': '负责人临时改变方向，但大家已经投入了两周。你会：',
    'b-disengage-1': '你连续三周高负荷，新的“紧急事情”又来了。你会：',
    'b-disengage-2': '一项重复工作每周占半天，却没人愿意改变做法。你会：',
    'b-disengage-3': '你发现现在的工作半年内很难再学到新东西。你会：',
    'b-disengage-4': '一件事情的关键决定反复被推翻，你已经不再相信它会成功。你会：',
    'b-execution-1': '不同团队讨论完一件事后，没有人记录负责人和时间。你会：',
    'b-execution-2': '临近截止时，你发现工作要求还有一个关键歧义。你会：',
    'b-execution-3': '事情做到 80% 时，关键协作人突然离开了。你会：',
    'b-execution-4': '一件事情没有硬截止时间，却会持续影响后续工作。你会：',
    'b-pleasing-1': '集体活动投票里，大家都选了你不喜欢的安排。你会：',
    'b-pleasing-2': '同事请你帮忙修改材料，这已经是本月第四次。你会：',
    'b-pleasing-3': '你不同意大家的判断，但所有人都已经点头。你会：',
    'b-pleasing-4': '你拒绝了一个请求，对方只回了“好吧”。你会：',
    'b-conflict-1': '同事连续打断你，并替你总结了一个错误结论。你会：',
    'b-conflict-2': '相关方拒绝承认延期责任，反而说是你的工作变化造成的。你会：',
    'b-conflict-3': '同事用玩笑方式反复评价你的能力。你会：',
    'b-conflict-4': '两个团队都不愿意承担一个关键衔接环节。你会：',
    'b-politics-1': '你的成果被拿去做重要说明，但你没有被邀请参加。你会：',
    'b-politics-2': '组织调整前，几位负责人突然频繁问你事情细节。你会：',
    'b-politics-3': '一件重要事情需要两位负责人共同支持，但他们意见相反。你会：',
    'b-politics-4': '机会名额有限，你和同事的结果比较接近。你会：',
  };
  const universalOptions = {
    drive: ['先确认价值和代价，再决定投入到什么程度。', '先接下来，做成之后再处理额外消耗。', '只完成必要部分，把时间留给更重要的事。', '先试一小步，用结果决定要不要继续。'],
    rumination: ['找一个事实或反馈，验证自己真正需要调整的地方。', '反复回想细节，担心是不是自己做得不够好。', '接受结果，不让一次评价占据全部注意力。', '找熟悉的人聊聊，再把情绪和事实分开。'],
    boundary: ['先说清职责、时间和能提供到哪一步。', '先答应下来，关系和现场稳定更重要。', '按约定完成，超出范围就请对方重新安排。', '先判断是否真正紧急，再决定投入多少。'],
    upward: ['带着事实、影响和备选办法，请负责人做取舍。', '先按对方说的做，别让沟通拖慢事情。', '私下确认真正目标，再决定怎么行动。', '把分歧写清楚，请相关人共同确认。'],
    execution: ['当场写下负责人、时间和下一步，避免靠记忆推进。', '先做最急的部分，其他之后再补。', '按现有记录完成，不替别人猜未说明的内容。', '先拆成最小一步，边做边补齐信息。'],
    pleasing: ['先听完对方，再说清自己能帮到哪一步。', '尽量接住，别让对方觉得你不够配合。', '礼貌拒绝，并给一个更小的替代办法。', '先答应一部分，之后再找合适时机说明压力。'],
    conflict: ['把事实和影响摆出来，直接讨论下一步。', '先把事情做完，责任问题之后再说。', '私下沟通，避免关系在公开场合变僵。', '先观察现场情绪，等更合适的时机再回应。'],
    disengage: ['设一个最低完成线，先保住基本结果。', '继续加码，忙完这一阵再恢复。', '只做约定范围，不为模糊期待额外透支。', '先暂停一下，确认这件事是否值得继续投入。'],
    politics: ['按时间线和贡献留痕，让事实自己说话。', '先把事情办成，不急着争取被看见。', '找关键决策人确认真正的判断标准。', '观察资源和责任如何流动，再决定站位。'],
  };
  data.questions.filter((question) => question.stage === 'anchor' || question.stage === 'branch').forEach((question) => {
    if (universalScenes[question.id]) question.scene = universalScenes[question.id];
    question.options.forEach((option, index) => { option.text = universalOptions[question.focus][index]; });
  });
